				...
				<div class="col-md-12">
					<div class="jumbotron">
						<?PHP
							...
							if($numero < 0)
							{
								echo "<h3 class='text-center'>O número digitado é negativo</h3>"; 
							}
							else if($numero > 0)
							{
								echo "<h3 class='text-center'>O número digitado é positivo</h3>"; 
							}
							else if($numero == 0)
							{
								echo "<h3 class='text-center'>O número digitado é igual a 0</h3>";
							}
						?>
					</div>
				</div>				
