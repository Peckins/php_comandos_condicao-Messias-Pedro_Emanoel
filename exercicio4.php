				...
				<div class="col-md-12">
					<div class="jumbotron">
						<?PHP
							...
							if($soma > $multi){
								echo "<h3 clas='text-center'>O resultado da soma é maior que o da multiplicação</h3>";
							}
							else if ($multi > $soma){
								echo "<h3 class='text-center'>O resultado da soma é menor que o da multiplicação</h3>";
							}
							else if ($soma == $multi){
								echo "<h3 class='text-center'>O resultado da soma é igual ao da multiplicação</h3>"; 
							}
						?>
					</div>
				</div>				
